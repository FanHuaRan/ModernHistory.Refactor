...
namespace ModernHistoryWebApi.Controllers
{
     ...
     // [Authorize]
      public class FamousPersonTypeController : ApiController
      {
            ...
            public IEnumerable<FamousPersonTypeInfo> Get()
            {
                  return FamousPersonTypeService.FindAll();
            }
            public FamousPersonTypeInfo Get(int id)
            {
            ...
            [HttpPost]
            public FamousPersonTypeInfo Save([FromBody]FamousPersonTypeInfo value)
            {
            ...
            [HttpPost]
            public void Update(int id, [FromBody]FamousPersonTypeInfo value)
            {
                  if (value != null && ModelState.IsValid)
                  {
